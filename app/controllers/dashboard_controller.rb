  ...
  def app_config
    {
      ...
      PANEL_AI_DEFAULT_WEBHOOK_URL: GlobalConfigService.load('PANEL_AI_DEFAULT_WEBHOOK_URL', ''),
      GIT_SHA: GIT_HASH,
      ALLOWED_LOGIN_METHODS: allowed_login_methods,
      ACTIVE_PLATFORM_BANNERS: active_platform_banners,
      DEPLOYMENT_ENV: ENV['DEPLOYMENT_ENV'].presence || GlobalConfig.get_value('DEPLOYMENT_ENV')
    }
  end
